...
@section('nav-menu')
    ...
    <a href="{{ route('operator.score_settings.index') }}" class="nav-link {{ request()->routeIs('operator.score_settings.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-3 rounded-xl font-medium transition-colors">
