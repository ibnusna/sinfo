...
@section('nav-menu')
    ...
    <a href="{{ route('operator.landing_photos.index') }}" class="nav-link {{ request()->routeIs('operator.landing_photos.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-3 rounded-xl font-medium transition-colors">
